...
class AssistantMethods {
  ...
  static double calculateFareAmountFromOriginToDestination(
    ...
    double timeTravelledFarePerMinute =
        (directionDetailsInfo.duration_value! / 60) * 0.01;

    double distanceTravelledFarePerKilometer =
        (directionDetailsInfo.distance_value! / 1000) * 0.05;

    // 1 USD = 80 Rupees then multiply by 80
    double totalFareAmount =
        (timeTravelledFarePerMinute + distanceTravelledFarePerKilometer) * 50;
  ...
  //trip key is same as ride request key
//in this method we will retrieve all the trip keys for the user
      ...
      FirebaseDatabase.instance.ref()
          ...
          .then((snap) {
           ...
           if((snap.snapshot.value as Map)["status"] == "ended"){
             //updating each overall trips history data
